module.exports = {
    ...
    rules: {
        ...
        // @useless: 'no-extra-parens',
        'no-extra-semi': [2],
        'no-func-assign': [2],
        // @useless: 'no-inner-declarations:': [2, 'both'],
        'no-invalid-regexp': [2],
        ...
        'block-scoped-var': [2],
        // @what's this 'consistent-return': [2, { "treatUndefinedAsUnspecified": true }]
        ...
        'prefer-const': [2, { destructuring: 'all', }], // @TODO
